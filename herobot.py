...
def initial_checker():
    ...
    try:
        ...
        *******************
        -- HEROTEK.ir --
        Welcome to Herotek Instagram Service , it seems this is the first time you've used this bot.
        ...
        Have fun with the bot! For Contact www.herotek.ir | +984433485429
        """)
        time.sleep(5)
        os.system('cls')
...
def setting_input():
    inputs = [("How many likes do you want to do in a day?", 1000),
              ...
              (("Maximal followers of account you want to follow?\n"
                "We will skip media that have greater followers than this value "), 100000),
              ...
              (("Maximum following of account you want to follow?\n"
                "We will skip media that have a greater following than this value "), 100000),
              (("Minimum following of account you want to follow?\n"
                "We will skip media that have lesser following from this value "), 10),
              ("Maximal followers to following_ratio ", 500),
              ...
              ("Delay from one unlike to another unlike you will perform ", 30),
